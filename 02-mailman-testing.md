...
In the bundler directory, open the mailman_web/testing.py file, look for the SECRET_KEY parameter and set something random.
    ...
    vim mailman-bundler/mailman_web/testing.py
    # SECRET_KEY = '[SET IT TO SOMETHING RANDOM]'
    # add 127.0.0.1, IP of the server and domain name in allowed_domain 
...
install passlib 1.6.5

    pip install passlib==1.6.5
    
Note: Some of libs may get updated and be imcompatible with mailman bundler. You have to manually downgrade the package. [Check the list](https://github.com/alex1007/mailman-on-aws/blob/master/packages_list.md)
